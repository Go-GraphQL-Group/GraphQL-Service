...
func convertPlanet(planet1 *model1.Planet) *Planet {
	planet2 := &Planet{}
...
func convertSpecie(specie1 *model1.Species) *Specie {
	specie2 := &Specie{}
...
func convertStarship(starship1 *model1.Starship) *Starship {
	starship2 := &Starship{}
...
func convertVehicle(vehicle1 *model1.Vehicle) *Vehicle {
	vehicle2 := &Vehicle{}
